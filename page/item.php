	...
	function init(){
		...
		$crud=$this->add('xepan\hr\CRUD',
						[
							...
							'edit_page'=>'xepan_custom_itemdetail'
						],
						null,
						['view/item/grid']
					);
		...
		if(!$crud->isEditing()){
			$crud->grid->js('click')->_selector('.do-view-item-detail')->univ()->frameURL('Item Details',[$this->api->url('xepan_custom_itemdetail'),'document_id'=>$this->js()->_selectorThis()->closest('[data-item-id]')->data('id')]);
		}
